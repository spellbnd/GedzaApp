  ...
  return (
    <ScrollView>
      ...
      <View style={{ width: '100%', paddingRight: 15, paddingLeft: 15 }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold', marginBottom: 8, lineHeight: 24 }}>Обязанности:</Text>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold', marginBottom: 8, lineHeight: 24, marginTop: 22 }}>Требования:</Text>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold', marginBottom: 8, lineHeight: 24, marginTop: 22 }}>Условия:</Text>
