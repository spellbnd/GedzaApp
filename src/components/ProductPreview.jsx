    ...
    return (
        ...
        <View style={styles.product_order}>
            ...
            <View>
                ...
                <Text style={{fontWeight: '700', marginBottom: 5, textAlign: 'center', fontSize: 14,}}>Годен в течении 3 часов при t 20°C, 12 часов при t 4±2°C</Text>
                <Text style={{marginBottom: 5, textAlign: 'center', fontSize: 14, color: '#AEAEAE', fontSize: 16}}>Изображение в приложении и внешний вид продукта могут отличаться</Text>
                <View style = {styles.viewStyleForLine}></View>
                <View style={styles.energy_amount}>
                <Text>Энерг. ценность</Text>
                <Text>{props.productInfo.productValue.energy_amount} ккал.</Text>
                </View>
                <View style={styles.fiber_amount}>
                <Text>Белки</Text>
                <Text>{props.productInfo.productValue.fiber_amount} г</Text>
                </View>
                <View style={styles.fat_amount}>
                <Text>Жиры</Text>
                <Text>{props.productInfo.productValue.fat_amount} г</Text>
                </View>
                <View style={styles.fat_amount}>
                <Text>Углеводы</Text>
                <Text>{props.productInfo.productValue.carbohydrate_amount} г</Text>
                </View>
                <View style={styles.fat_amount}>
                <Text>Вес</Text>
                <Text>{props.productInfo.productValue.weight_amount} г.</Text>
                </View>
                <View style={styles.product_purchase}>
                  <Pressable style={styles.btn} onPress={() => {
                    ...
                    <Text style={{fontWeight: 600, fontSize:20}}>{props.productInfo.price}{'\u20BD'}</Text>
                </View>
